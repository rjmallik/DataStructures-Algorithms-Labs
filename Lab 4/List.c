...
* Matrix.c
*The Matrix.c file implements operations and management for a matrix data structure, including functions to create and manipulate matrices, such as adding, subtracting, and multiplying matrices, alongside utilities for memory management like allocating and freeing matrix elements.
***/
#include <stdio.h>
#include <stdlib.h>
#include "Matrix.h"
